...
router.post('/add', isLoggedIn, IsAuthorized('addProcesses'), async (req, res) => {
...
router.post('/listStages', isLoggedIn, IsAuthorized('seeListProcesses'), async (req, res) => {
...
router.post('/listProducts', isLoggedIn, IsAuthorized('seeListProcesses'), async (req, res) => {
...
router.post('/edit/:id', isLoggedIn, IsAuthorized('editProcesses'), async (req, res)=>{
    const {id} = req.params;
    const proceso = req.body;

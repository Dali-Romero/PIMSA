...
helpers.createPdfQuotations = async (dataDb, dataCallback, endCallback) => {
    // font description
...
helpers.createPdfOrders = async (dataDb, dataCallback, endCallback) => {
    // font description
    const fontDescription = {
        Roboto: {
            normal: path.join(process.cwd(), 'src', 'public', 'fonts', 'Open_Sans', 'static', 'OpenSans_Condensed-Regular.ttf') ,
    ...
    // product structuring
    let productosEstructurados = [];
    let procesosEstructurados = [];
    dataDb.productos.forEach(producto => {
        for (let i = 0; i < producto.ordenAreas.length; i++) {
            procesosEstructurados.push(
                [
                    {text: `${producto.ordenAreas[i]}.- ${producto.areas[i]}`, colSpan: 1, style: 'tableContent', background: '#fff', color: '#000', border: [true, false, true, true], alignment: 'left', margin: [6, 0, 0, 6]}
                ]
            )
        }
                ...
                stack: [
                    {
                        table: {
                            ...
                            body: [
                                [
                                    {text: 'Proceso asociado:', style: 'tableContentProductBold', colSpan: 1, fillColor: '#fff', color: '#000', border: [true, false, false, false], alignment: 'left', margin: [6, 0, 0, 0]},
                                    {text: producto.procesoNombre, style: 'tableContentProduct', colSpan: 1, fillColor: '#fff', color: '#000', border: [false, false, true, false], alignment: 'left', margin: [0, 0, 0, 0]},
                                ]
                            ]
                        },
                        layout: {
        ...
        content: [
            {
                columns: [
                    {   
                        width: '45%',
                        stack: [
                            {image: path.join(process.cwd(), 'src', 'public', 'img', 'PIMSAlogo.png'), width: 225, height: 50, alignment: 'center', margin: [0, 0, 0, 6]},
                            {
                                table: {
                                    widths: ['41%', '18%', '17%', '24%'],
                                    body: [
                                        [{text: 'Información de la orden', style: 'tableHeader', colSpan: 4, fillColor: '#dc3545', color: '#fff', border: [false, false, false, false], alignment: 'center'}, {}, {}, {}],
                                        [
                                            {text: 'No. orden:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]}, 
                                            {text: `OT-${dataDb.cotizacion.ordenId}`, style: 'tableContent', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {text: 'Estatus:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [0, 0, 0, 0]}, 
                                            {text: dataDb.cotizacion.estatusOrden, style: 'tableContent', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [0, 0, 0, 0]},
                                        ],
                                        [
                                            {text: 'Cotización asociada:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {text: `COT-${dataDb.cotizacion.cotId}`, style: 'tableContent', colSpan: 3, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {},
                                            {}
                                        ],
                                        [
                                            {text: 'Fecha de generación:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]}, 
                                            {text: formatDatePDF(dataDb.cotizacion.fechaGen), style: 'tableContent', colSpan: 3, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {},
                                            {}
                                        ],
                                        [
                                            {text: 'Fecha de entrega:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]}, 
                                            {text: formatDateOnlyDate(dataDb.cotizacion.fechaEnt), style: 'tableContent', colSpan: 3, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {},
                                            {}
                                        ],
                                        [
                                            {text: 'Proyecto:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]}, 
                                            {text: dataDb.cotizacion.proyecto, style: 'tableContent', colSpan: 3, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {},
                                            {}
                                        ],
                                        [
                                            {text: 'Empleado:', style: 'tableContentBold', colSpan: 1, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]}, 
                                            {text: dataDb.cotizacion.nombreComp, style: 'tableContent', colSpan: 3, fillColor: '#f8f9fa', color: '#000', border: [false, false, false, true], alignment: 'left', margin: [3, 0, 0, 0]},
                                            {},
                                            {}
                                        ]
                                    ]
